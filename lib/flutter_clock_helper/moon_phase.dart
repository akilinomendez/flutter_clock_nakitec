...
class MoonPhase {  
  ...
  double t = date.millisecondsSinceEpoch.toDouble() * (1 / 3155760000000) - 0.3;

  // lunar mean elongation (Astronomical Algorithms, 2nd ed., p. 338)
  double d = 297.8501921 + t * (445267.1114034 + t * (-0.0018819 + t * ((1 / 545868) + t * (-1 / 113065000))));

   // solar mean anomaly (p. 338)
  double m = 357.5291092 + t * (35999.0502909 + t * (-0.0001536 + t * (1 / 24490000)));

  // lunar mean anomaly (p. 338)
  double n = 134.9633964 + t * (477198.8675055 + t * (0.0087414 + t * ((1 / 69699) + t * (-1 / 14712000))));
  ...
  double i = 180 - d - 6.289 * sinn + 2.100 * sinm - 1.274 * sin2dn - 0.658 * sin2d - 0.214 * sin2n - 0.110 * sind;
